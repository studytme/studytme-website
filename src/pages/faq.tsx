  ...
  return (
    <div>
      ...
      <div className="mx-5 my-24 lg:mx-60">
        ...
        <div className="">
          <div className="justify-between p-8 transition-shadow bg-white shadow-xl rounded-xl group ">
            ...
            <p>
              ...
              complete the task. The knowledge that someone is “present” and aware that you are
              doing the task is intended to increase motivation and follow-through.
        ...
        <div className="my-5">
          <div className="justify-between p-8 transition-shadow bg-white shadow-xl rounded-xl group ">
            <h1 className="text-xl font-bold lg:text-2xl lg:mb-2 md:text-xl">
        ...
        <div className="my-5">
          <div className="justify-between p-8 transition-shadow bg-white shadow-xl rounded-xl group ">
            <h1 className="text-xl font-bold lg:text-2xl lg:mb-2 md:text-xl">How did it start</h1>
            <p>
              G started streaming in November 2020 because her intership went fully remote and she
        ...
        <div className="my-5">
          <div className="justify-between p-8 transition-shadow bg-white shadow-xl rounded-xl group ">
            <h1 className="text-xl font-bold lg:text-2xl lg:mb-2 md:text-xl">
              How we differ from the hustle culture
            </h1>
            <p>
              The CEOgang places a lot of importance into using your energies effectively and
